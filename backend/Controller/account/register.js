...
router.get('/read/artist/:id?',Authorize,async (req,res)=>{
    req.body.search_id = req.params.id
    const result = await Service.ReadArtist(req.body).catch(e=>Helper.c(e));
    Response(req,res,result);
});
router.get('/read/organize/:id?',Authorize,async (req,res)=>{
    req.body.search_id = req.params.id
    const result = await Service.ReadOrganize(req.body).catch(e=>Helper.c(e));
    Response(req,res,result);
});
